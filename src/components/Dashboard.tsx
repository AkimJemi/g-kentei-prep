            ...
            <div className="max-w-6xl mx-auto text-center space-y-6 py-8 md:py-12 relative">
                ...
                <motion.div variants={itemVariants} className="pt-4 md:pt-8 flex flex-col sm:flex-row justify-center gap-3 sm:gap-4">
                    ...
                    >
                        ...
                        <span>学習開始</span>
                        <span className="hidden xl:inline text-[10px] font-black text-primary/60 ml-2 group-hover:text-primary transition-colors">[S]</span>
                    </button>
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 gap-3">
                        <div className="flex items-center justify-between p-3 bg-slate-800/30 rounded-xl border border-slate-700/30">
                            <span className="text-sm text-slate-300 font-medium">学習開始</span>
                            <div className="flex gap-2">
                                <kbd className="bg-slate-900 border border-slate-700 px-2 py-1 rounded text-xs text-slate-400 font-mono">S</kbd>
